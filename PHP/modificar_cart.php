...
<tbody>
            ...
            ?>
<?php if ($carrito_venta[$i]['ref'] != 'portes'){ ?>
<tr>
...
<form id="form2" name="form1" method="post" action="cart.php">
          ...
          <input  name="cantidad" type="text" id="cantidad" style="width:50px;" class="align-middle text-center"   value="<?php print $carrito_venta[$i]['cantidad'];   ?>" size="1" maxlength="4"  />
          <input  type="image" name="imageField3" src="../IMG_PROD/actualiza.png" height="13%" width="13%" value="" class="btn btn-sm btn-primary btn-rounded" />
          </form>   
</td>



<td style="vertical-align: middle;"><?php echo $carrito_venta[$i]['nombre'] ?></td>
<td style="vertical-align: middle;">$ <?php echo $carrito_venta[$i]['precio'] ?></td>
<td style="vertical-align: middle;">$ <?php echo $carrito_venta[$i]['precio'] * $carrito_venta[$i]['cantidad']; ?></td>
<td style="vertical-align: middle;">
